  ...
  return (
    <div className="space-y-6">
      {thoughts.map((thought) => {
        const createdAt = new Date(thought.createdAt || thought.date);
        const formattedDate = createdAt.toLocaleDateString("en-AU", {
          day: "numeric",
          month: "long",
          year: "numeric",
        });
        const formattedTime = createdAt.toLocaleTimeString("en-AU", {
          hour: "2-digit",
          minute: "2-digit",
        });
